          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center">
                <span className="px-4 bg-gray-900/50 text-white/40">{t("auth.or", language)}</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-white/60 mb-2">{t("auth.email", language)}</label>
                <div className="relative">
              ...
              <div>
                <label className="block text-white/60 mb-2">{t("auth.password", language)}</label>
                <div className="relative">
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
            ...
            <Button
              ...
              {t("auth.googleSignIn", language) || "Continuar com Google"}
            </Button>

            <div className="relative flex items-center justify-center text-xs uppercase text-white/40 mb-6">
              <span className="absolute left-0 w-full border-t border-white/10" />
              <span className="relative bg-[#0a0a0a] px-2">{t("auth.or", language)}</span>
            </div>
